...
mod test {
    ...
    use tinytrace_backend::{
        binding, Binding, BindingType, Buffer, BufferRequest, BufferType, BufferWrite, Context,
        Error, Extent, Handle, Lifetime, MemoryLocation, Shader, ShaderRequest,
    };
    ...
    impl BdsfSampler {
        ...
        fn sample(
            ...
            let results: &[BsdfEvalResult] =
                bytemuck::cast_slice(&download.buffers[&result_buffer]);
